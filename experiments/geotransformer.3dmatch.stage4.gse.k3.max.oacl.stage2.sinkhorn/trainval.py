...
class Trainer(EpochBasedTrainer):
    def __init__(self, cfg):
        ...
        # load checkpoint
        # state = torch.load('/home/ajy/GeoTransforme_update/output/geotransformer.3dmatch.stage4.gse.k3.max.oacl.stage2.sinkhorn/snapshots/epoch-9.pth.tar')
        ...
        # self.load_snapshot('/home/ajy/GeoTransforme_update/output/geotransformer.3dmatch.stage4.gse.k3.max.oacl.stage2.sinkhorn/snapshots/snapshot.pth.tar')
